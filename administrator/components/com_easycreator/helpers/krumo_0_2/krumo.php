 ...
 *
 * @package Krumo
 * @version $Id: krumo.php 401 2011-05-25 14:25:21Z elkuku $
 */
...
Class krumo {
    ...
    Public Static Function backtrace() {
        ...
        //
        ?>
<div class="krumo-title"><?php echo jgettext('Backtrace'); ?></div>
        <?php
        $ts = debug_backtrace();
    ...
    Public Static Function classes() {
        ...
        //
        ?>
<div class="krumo-title">Classes</div>
        <?php
    ...
    Public Static Function interfaces() {
        ...
        //
        ?>
<div class="krumo-title">Interfaces</div>
        <?php
    ...
    Public Static Function includes() {
        ...
        //
        ?>
<div class="krumo-title">Included (or required) files.</div>
        <?php
    ...
    Public Static Function functions() {
        ...
        //
        ?>
<div class="krumo-title">Functions</div>
        <?php
    ...
    Public Static Function defines() {
        ...
        //
        ?>
<div class="krumo-title">Defines</div>
        <?php
    ...
    Public Static Function extensions() {
        ...
        //
        ?>
<div class="krumo-title">PHP extensions.</div>
        <?php
    ...
    Public Static Function headers() {
        ...
        //
        ?>
<div class="krumo-title">HTTP request headers.</div>
        <?php
    ...
    Public Static Function phpini() {
        ...
        //
        ?>
<div class="krumo-title">Configuration settings read from <code><b><?php echo get_cfg_var('cfg_file_path');?></b></code>.
</div>
        <?php
    ...
    Public Static Function conf() {
        ...
        //
        ?>
<div class="krumo-title">Configuration settings</div>
        <?php
    ...
    Public Static Function path() {
        ...
        //
        ?>
<div class="krumo-title"><code><b>include_path</b></code></div>
        <?php
    ...
    Public Static Function request() {
        ...
        //
        ?>
<div class="krumo-title"><code><b>$_REQUEST</b></code></div>
        <?php
    ...
    Public Static Function get() {
        ...
        //
        ?>
<div class="krumo-title"><code><b>$_GET</b></code></div>
        <?php
    ...
    Public Static Function post() {
        ...
        //
        ?>
<div class="krumo-title"><code><b>$_POST</b></code></div>
        <?php
    ...
    Public Static Function server() {
        ...
        //
        ?>
<div class="krumo-title"><code><b>$_SERVER</b></code></div>
        <?php
    ...
    Public Static Function cookie() {
        ...
        //
        ?>
<div class="krumo-title"><code><b>$_COOKIE</b></code></div>
        <?php
    ...
    Public Static Function env() {
        ...
        //
        ?>
<div class="krumo-title"><code><b>$_ENV</b></code></div>
        <?php
    ...
    Public Static Function session() {
        ...
        //
        ?>
<div class="krumo-title"><code><b>$_SESSION</b></code></div>
        <?php
    ...
    Public Static Function ini($ini_file) {
        ...
        //
        ?>
<div class="krumo-title"><code><b><?php echo realpath($ini_file) ? realpath($ini_file) : $ini_file;?></b></code>
INI file.</div>
        <?php
        return krumo::dump($_);
    }
...
<?php echo krumo::_dump($data);?>
	<li class="krumo-footnote"><?php if (@$d['file']) { ?> <span
		class="krumo-call" style="white-space: nowrap;"> Called from <code><?php echo str_replace(JPATH_BASE.DS, '', $d['file']); ?></code>,
	line <code><?php echo $d['line']?></code></span> <?php } ?> &nbsp; <!--
...
<div class="krumo-element" onMouseOver="krumo.over(this);"
	onMouseOut="krumo.out(this);"><a class="krumo-name"><?php echo $name;?></a>
(<em class="krumo-type krumo-null">NULL</em>)</div>
</li>
        <?php
    }
...
<ul class="krumo-node">
	<li class="krumo-child">
	<div class="krumo-element" onMouseOver="krumo.over(this);"
		onMouseOut="krumo.out(this);"><a class="krumo-name"><big>&#8734;</big></a>
	(<em class="krumo-type">Recursion</em>)</div>
...
<div
	...
	<?php if (count($data) > 0) {?> onClick="krumo.toggle(this);"
	<?php } ?> onMouseOver="krumo.over(this);"
	onMouseOut="krumo.out(this);"><a class="krumo-name"><?php echo $name;?></a>
...
if (is_callable($data)) {
    $_ = array_values($data);
    ?> <span class="krumo-callback"> | (<em class="krumo-type">Callback</em>)
<strong class="krumo-string"><?php
echo htmlSpecialChars($_[0]);?>::<?php
echo htmlSpecialChars($_[1]);?>();</strong></span> <?php
}
?></div>
...
<div
	...
	<?php } ?> onMouseOver="krumo.over(this);"
	onMouseOut="krumo.out(this);"><a class="krumo-name"><?php echo $name;?></a>
(<em class="krumo-type">Object</em>) <strong class="krumo-class"><?php echo get_class($data);?></strong>
</div>
...
<div class="krumo-element" onMouseOver="krumo.over(this);"
	onMouseOut="krumo.out(this);"><a class="krumo-name"><?php echo $name;?></a>
(<em class="krumo-type">Resource</em>) <strong class="krumo-resource"><?php echo get_resource_type($data);?></strong>
</div>
...
<div class="krumo-element" onMouseOver="krumo.over(this);"
	onMouseOut="krumo.out(this);"><a class="krumo-name"><?php echo $name;?></a>
(<em class="krumo-type">Boolean</em>) <strong class="krumo-boolean"><?php echo $data?'TRUE':'FALSE'?></strong>
</div>
...
<div class="krumo-element" onMouseOver="krumo.over(this);"
	onMouseOut="krumo.out(this);"><a class="krumo-name"><?php echo $name;?></a>
(<em class="krumo-type">Integer</em>) <strong class="krumo-integer"><?php echo $data;?></strong>
</div>
...
<div class="krumo-element" onMouseOver="krumo.over(this);"
	onMouseOut="krumo.out(this);"><a class="krumo-name"><?php echo $name;?></a>
(<em class="krumo-type">Float</em>) <strong class="krumo-float"><?php echo $data;?></strong>
</div>
...
<?php if ($_extra) {?> onClick="krumo.toggle(this);" <?php } ?>
	onMouseOver="krumo.over(this);" onMouseOut="krumo.out(this);"><a
	class="krumo-name"><?php echo $name;?></a> (<em class="krumo-type">String,
<strong class="krumo-string-length"><?php
					echo strlen($data) ?> characters</strong> </em>) <strong
	class="krumo-string"><?php echo htmlSpecialChars($_);?></strong> <?php
			// callback ?
			//
			if (is_callable($data)) {
				?> <span class="krumo-callback"> | (<em class="krumo-type">Callback</em>)
