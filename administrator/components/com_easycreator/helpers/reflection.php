<?php
/**
 * @version $Id: reflection.php 464 2011-07-27 20:31:11Z elkuku $
 * @package    EasyCreator
 * @subpackage Helpers
...
class easyReflection
{
     ...
     * @return void
     */
    public function reflectProject(EasyProject $project)
    {
        switch($project->type)
        {
            case 'component':
     ...
     * @return void
     */
    public function aj_reflectProject(EasyProject $project)
    {
        switch($project->type)
        {
            case 'component':
