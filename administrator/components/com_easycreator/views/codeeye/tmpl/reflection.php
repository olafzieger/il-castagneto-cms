<?php
/**
 * @version SVN: $Id: reflection.php 434 2011-07-02 20:27:06Z elkuku $
 * @package    EasyCreator
 * @subpackage Views
...
function displayReflectedFiles($reflections, $type, EasyProject $project)
{
    switch ($type)
    {
        case 'controllers':
						...
						<td>
                            ...
                            foreach($refl->methods as $method)
                            {
                                ...
                                .'<br />'.jgettext('Lines').' # '.$method->startLine.' - '.$method->endLine;
                                    ...
                                    echo NL.'</a>';
//echo NL.'<span class="doccomment_sourcecode hasEasyTip" title="'.$fileLocation.'">';
