<?php
/**
 * @version SVN: $Id: jhelp.php 434 2011-07-02 20:27:06Z elkuku $
 * @package	EasyCreator
 * @subpackage	Help
...
<div style="border: 1px solid orange; padding: 0.5em; background-color: #eee;">
    ...
    <ul style="list-style: none; padding-left: 0.5em;">
    	<li class="img icon-16-joomla">
    		<a href="http://docs.joomla.org/API_Reference_Project" class="external">Help docs.joomla.org</a>
    	</li>
    	<li class="img icon-16-joomla">
		...
		<td>
            ...
            foreach($formats as $f):
                $selected =($f[2] == $out_format) ? '_selected' : '';
                echo '<span class="ecr_button'.$selected.'" id="'.$f[2].'"'
...
?>
			...
			width="100%" marginwidth="0" marginheight="0" frameborder="0">NO FRAMES IN YOUR BROWSER ??</iframe>
			<script type="text/javascript">
	$('jhelpDisplay').onload = function() { $('linkDisplay').className = ''; };
</script>
