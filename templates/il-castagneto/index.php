...
//                echo $templateparams->get('sitedescription');   //Beschreibung Template-Parameter
               	if ($templateparams->get('hintergrundbild') != "") {
               		$hg_image = " style=\"background-image: url('" . $this->baseurl . "/templates/" . $this->template . "/images/" . $templateparams->get('hintergrundbild') . "')" . '"';
               	} else {
               		$hg_image = "";
               	}
               ?>
